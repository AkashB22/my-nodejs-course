...
server.router = {
    ...
    'example/errorPage' : handler.errorPage,
};
...
server.unifiedServer = function(req, res){
     ...
     req.on('end', function(){
         ...
         chosenHandler(data, function(statusCode, payload, contentType){
                ...
                debug(e);
                server.processHandlerResponse(res, method, trimpath, 500, {'Error' : 'An error occurred while processing the request'}, 'json');
            }
...
server.processHandlerResponse = function(res, method, trimpath, statusCode, payload, contentType){
